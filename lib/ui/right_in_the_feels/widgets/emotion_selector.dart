...
class EmotionSelector extends StatefulWidget {
  final List<EmotionUiModel> rootEmotions;
  final void Function(
    EmotionUiModel? selectedLevel1,
    EmotionUiModel? selectedLevel2,
    EmotionUiModel? selectedLevel3,
  )? onSelectionChanged;
...
class _EmotionSelectorState extends State<EmotionSelector> {
  ...
  void _selectLevel2(EmotionUiModel emotion) {
    setState(() {
  ...
  void _selectLevel3(EmotionUiModel emotion) {
    setState(() {
  ...
  Widget _buildAnimatedEmotionLevel({
    required List<EmotionUiModel> emotions,
    required EmotionUiModel? selectedEmotion,
    required Function(EmotionUiModel) onSelect,
    required int level,
  }) {
    return AnimatedSize(
